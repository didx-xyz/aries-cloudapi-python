...
class AttachDecoratorData(BaseModel):
    ...
    json_embedded: Optional[Dict[str, Any]] = Field(alias="json")
...
class ConnectionStaticRequest(BaseModel):
    ...
    def their_endpoint_pattern(cls, value):
        assert value is not None and re.match(
            r"/^[A-Za-z0-9\.\-\+]+:\/\/([A-Za-z0-9][.A-Za-z0-9-]+[A-Za-z0-9])+(:[1-9][0-9]*)?(\/[^?&amp;#]+)?$/",
            value,
        )
        return value
...
class DIDDoc(BaseModel):
    ...
    def did_doc_pattern(cls, value):
        assert value is not None and re.match(
            r"/^did:([a-z0-9]+):((?:[a-zA-Z0-9._-]*:)*[a-zA-Z0-9._-]+)$/", value
        )
        return value
...
class DIDEndpoint(BaseModel):
    ...
    def endpoint_pattern(cls, value):
        assert value is None or re.match(
            r"^[A-Za-z0-9\.\-\+]+:\/\/([A-Za-z0-9][.A-Za-z0-9-]+[A-Za-z0-9])+(:[1-9][0-9]*)?(\/[^?&amp;#]+)?$",
            value,
        )
        return value
...
class ConnectionApi(Consumer):
    ...
    def create_static(
        self,
        body: Body(type=ConnectionStaticRequest),
    ...
    def set_metadata(
        self,
        conn_id: str,
        body: Body(type=ConnectionMetadataSetRequest),
    ) -> ConnectionMetadata:
...
class EndorseTransactionApi(Consumer):
    ...
    def get_single_transaction_record(
        self,
        tran_id: str,
    ) -> TransactionRecord:
    ...
    def set_endorser_info(
        self,
        conn_id: str,
        endorser_did: Query = None,
        endorser_name: Query = None,
    ) -> EndorserInfo:
        """Set Endorser Info"""

    @post("/transactions/{conn_id}/set-endorser-role")
    def set_transaction_jobs(
        self,
        conn_id: str,
        transaction_my_job: Query = None,
    ) -> TransactionJobs:
        """Set transaction jobs"""

    @post("/transactions/{tran_id}/write")
    def write_transaction_to_ledger(
        self,
        tran_id: str,
    ) -> TransactionRecord:
...
class IntroductionApi(Consumer):
    ...
    def send_introduction(
        self,
        conn_id: str,
        target_connection_id: Query = None,
        message: Query = None,
    ) -> object:
...
class IssueCredentialV10Api(Consumer):
    ...
    def send_credential_to_holder_auto_entire_flow(
        self,
    ...
    def send_holder_credential(
        self,
        cred_ex_id: str,
        body: Body(type=V10CredentialIssueRequest),
    ) -> V10CredentialExchange:
        """Send holder a credential"""

    @post("/issue-credential/send")
    def send_holder_credential_auto_entire_flow(
        self,
    ...
    def send_issuer_credential_request(
        self,
        cred_ex_id: str,
    ) -> V10CredentialExchange:
    ...
    def send_problem_report_for_credex_exchange(
        self,
        cred_ex_id: str,
...
class IssueCredentialV20Api(Consumer):
    ...
    def create_credential_issue(
        self,
        body: Body(type=V20IssueCredSchemaCore),
    ) -> V20CredExRecord:
        """Send holder a credential, automating entire flow"""
    ...
    def send_credential_to_holder(
        self,
        cred_ex_id: str,
        body: Body(type=V20CredIssueRequest),
    ) -> V20CredExRecordDetail:
        """Send holder a credential"""
    ...
    def send_holder_credential_offer(
        self,
        cred_ex_id: str,
        body: Body(type=V20CredBoundOfferRequest),
    ) -> V20CredExRecord:
        """Send holder a credential offer in reference to a proposal with preview"""
    ...
    def send_holder_offer(
        self,
        body: Body(type=V20CredOfferRequest),
    ) -> V20CredExRecord:
        """Send holder a credential offer, independent of any proposal"""

    @post("/issue-credential-2.0/send-request")
    def send_issuer_credential(
        self,
        body: Body(type=V20CredRequestFree),
    ) -> V20CredExRecord:
    ...
    def send_problem_report(
        self,
        cred_ex_id: str,
        body: Body(type=V20CredIssueProblemReportRequest),
    ) -> object:
        """Send a problem report for credential exchange"""
    ...
    def store_received_credential(
        self,
        cred_ex_id: str,
        body: Body(type=V20CredStoreRequest),
    ) -> V20CredExRecordDetail:
        """Store a received credential"""
...
class MediationApi(Consumer):
    ...
    def deny_stored_mediation_request(
        self,
        mediation_id: None,
        body: Body(type=AdminMediationDeny),
    ) -> MediationDeny:
    ...
    def get_medition_request_record(
        self,
        mediation_id: str,
    ) -> MediationRecord:
    ...
    def request_mediation_from_connection(
        self,
        conn_id: str,
        body: Body(type=MediationCreateRequest),
    ) -> MediationRecord:
    ...
    def send_keylist_update_to_mediator(
        self,
        mediation_id: str,
        body: Body(type=KeylistUpdateRequest),
    ) -> KeylistUpdate:
...
class MultitenancyApi(Consumer):
    ...
    def create_subwallet(
        self,
        body: Body(type=CreateWalletRequest),
    ...
    def get_subwallets(
        self,
        wallet_name: Query = None,
    ) -> WalletList:
        """Query subwallets"""

    @post("/multitenancy/wallet/{wallet_id}/token")
    def get_token_for_subwallet(
        self,
        wallet_id: str,
    ...
    def remove_subwallet(
        self,
        wallet_id: str,
        body: Body(type=RemoveWalletRequest),
    ) -> object:
        """Remove a subwallet"""
    ...
    def update_subwallet(
        self,
        wallet_id: str,
        body: Body(type=UpdateWalletRequest),
    ) -> WalletRecord:
        """Update a subwallet"""
...
class OutOfBandApi(Consumer):
    ...
    def receive_invitation(
        self,
        body: Body(type=InvitationReceiveRequest),
        alias: Query = None,
        auto_accept: Query = None,
        mediation_id: Query = None,
...
class PresentProofV10Api(Consumer):
    ...
    def get_credentials_for_presentation_request(
        self,
        pres_ex_id: str,
        count: Query = None,
    ...
    def present_proof_presentation(
        self,
        pres_ex_id: str,
        body: Body(type=IndyPresSpec),
    ) -> V10PresentationExchange:
        """Sends a proof presentation"""

    @delete("/present-proof/records/{pres_ex_id}")
    def remove_presex_record(
        self,
        pres_ex_id: str,
    ) -> object:
    ...
    def send_presentation_request(
        self,
        pres_ex_id: str,
        body: Body(type=AdminAPIMessageTracing),
    ) -> V10PresentationExchange:
    ...
    def send_proposal(
        self,
        body: Body(type=V10PresentationProposalRequest),
    ) -> V10PresentationExchange:
    ...
    def send_request(
        self,
        body: Body(type=V10PresentationCreateRequestRequest),
    ) -> V10PresentationExchange:
    ...
    def send_request_0(
        self,
        body: Body(type=V10PresentationSendRequestRequest),
    ) -> V10PresentationExchange:
...
class PresentProofV20Api(Consumer):
    ...
    def create_presentation_request(
        self,
        body: Body(type=V20PresCreateRequestRequest),
    ) -> V20PresExRecord:
        """Creates a presentation request not bound to any proposal or connection"""

    @get("/present-proof-2.0/records/{pres_ex_id}/credentials")
    def get_credentials_for_presex_request(
        self,
        pres_ex_id: str,
        count: Query = None,
        extra_query: Query = None,
    ...
    def send_problem_report(
        self,
        pres_ex_id: str,
        body: Body(type=V20PresProblemReportRequest),
    ) -> object:
        """Send a problem report for presentation exchange"""
    ...
    def send_proposal(
        self,
        body: Body(type=V20PresProposalRequest),
    ) -> V20PresExRecord:
        """Sends a presentation proposal"""
    ...
    def send_request(
        self,
        body: Body(type=V20PresSendRequestRequest),
    ) -> V20PresExRecord:
        """Sends a free presentation request not bound to any proposal"""
...
class RevocationApi(Consumer):
    ...
    def get_credential_revocatio_status(
        self,
    ...
    def get_revocation_registry_by_revocation_registry_id(
        self,
        rev_reg_id: str,
    ) -> object:
...
class WalletApi(Consumer):
    ...
    @post("/wallet/did/create")
    def create_default_did(self) -> DIDResult:
