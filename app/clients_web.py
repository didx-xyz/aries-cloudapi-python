...
async def convert_revocation_event(event: Event, redis: Redis):
    # convert event to lago_event
...
async def convert_issuer_cred_rev_revoked_event(event: Event, redis: Redis):
    # convert event to lago_event
