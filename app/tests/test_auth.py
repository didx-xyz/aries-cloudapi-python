...
async def test_governance_agent(governance_acapy_client: AcaPyClient):
    ...
    assert (
        governance_acapy_client.api_client.default_headers["x-api-key"]
...
async def test_tenant_agent():
    ...
    assert (
        alice_acapy_client.api_client.default_headers["x-api-key"]
...
async def test_tenant_admin_agent(tenant_admin_acapy_client):
    ...
    assert (
        tenant_admin_acapy_client.api_client.default_headers["x-api-key"]
        == TENANT_ACAPY_API_KEY
    )
