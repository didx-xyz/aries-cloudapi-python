...
async def remove_wallet(
    async_client: AsyncClient, wallet_id: str, role: str = "member"
):
...
async def create_wallet(
    async_client: AsyncClient, wallet_name: str, role: str = "member"
):
    rand = random.random()
...
async def create_invitation(
    async_client: AsyncClient, token: str, role: str = "member"
):
