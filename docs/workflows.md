...
- Created a schema (using the governance agent)
- Registered a schema on the ledger (via the governance agent)
...
and replacing `YOUR_CONTAINER_NAME` with the name of the container you want to follow (eg webhooks-web). You can find the container name in the docker-compose.yaml.
