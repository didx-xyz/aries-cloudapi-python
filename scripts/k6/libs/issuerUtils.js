// issuerUtils.js
import { getWalletIdByWalletName, getAccessTokenByWalletId, createIssuerTenant } from './tenant.js';
  ...
  if (issuerWalletId !== null) {
    ...
    try {
      ...
      if (createIssuerTenantResponse.status !== 200) {
        throw new Error(`Failed to create issuer tenant. Status: ${createIssuerTenantResponse.status}`);
      }
