...
LAGO_URL = os.getenv("LAGO_URL", "http://192.168.0.186:3000/api/v1/events")  # use pc ip address 
LAGO_API_KEY = os.getenv("LAGO_API_KEY", "cb131628-c605-49bd-8aa3-93fe0289e1a3")
